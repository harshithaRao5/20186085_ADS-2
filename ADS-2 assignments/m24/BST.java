...
class BST {
    public static void main(String[] args) {
        ...
        int n = scan.nextInt();
        BinarySearchTree<Integer, String> linkImp = new BinarySearchTree<Integer, String>();
        ...
        while (n > 0) {
            ...
            switch (tokens[0]) {
            case"put":
                linkImp.put(Integer.parseInt(tokens[1]), tokens[2]);
                //System.out.println(swobj.elapsedTime());

                break;
            case"get":
                System.out.println(linkImp.get(Integer.parseInt(tokens[1])));
                //System.out.println(swobj.elapsedTime());

                break;
            case"delete":
                linkImp.delete(Integer.parseInt(tokens[1]));
                //System.out.println(swobj.elapsedTime());
            }
            n--;
        }
